#!/bin/bash
#: Create a Vue3 + TypeScript + Vitest project with Prettier and Vite.
...
echo "Creating Vue + TS + Vitest project in $PROJECT_PATH ..."
...
echo "Vue + TS + Vitest project created and ready: $PROJECT_NAME"
