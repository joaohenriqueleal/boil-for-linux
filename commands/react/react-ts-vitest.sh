#!/bin/bash
#: Create a React + TypeScript + Vitest project with Prettier and Vite.
...
echo "Creating React + TS + Vitest project in $PROJECT_PATH ..."
...
echo "React + TS + Vitest project created and ready: $PROJECT_NAME"
